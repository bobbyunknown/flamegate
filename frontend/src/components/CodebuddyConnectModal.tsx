...
export function CodebuddyConnectModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <Modal open={true} onClose={onClose} title="Connect CodeBuddy" maxWidth="max-w-md">
      ...
      <div className="flex items-center justify-between rounded-xl border border-border bg-muted px-4 py-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Complete sign-in on the other tab</p>
          </div>
        </div>
