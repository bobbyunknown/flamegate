...
const BrandingContext = createContext<BrandingContextValue>({
  ...
  logoSrc: "/flamegate-favicon.svg",
  faviconSrc: "/flamegate-favicon.svg",
  isLoading: false,
});
...
export function AdminBrandingProvider({ children }: { children: ReactNode }) {
  ...
  const logoSrc = branding.logo_url || "/flamegate-favicon.svg";
  const faviconSrc = branding.favicon_url || "/flamegate-favicon.svg";
...
export function PortalBrandingProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const title = branding.name || "FlameGate";
