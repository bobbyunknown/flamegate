...
// given base URL and model. The baseURL is the public FlameGate endpoint (with
...
model = "%s"
model_provider = "flamegate"

[model_providers.flamegate]
name = "FlameGate"
base_url = "%s"
wire_api = "chat"
...
env_file = "~/.config/jcode/provider-flamegate.env"
default_model = "%s"
requires_api_key = true

[[providers.flamegate.models]]
id = "%s"
name = "%s"

# ~/.config/jcode/provider-flamegate.env
JCODE_FLAMEGATE_API_KEY="%s"`, baseURL, model, model, model, apiKey)
	return cliToolSnippet{
		ID:           "jcode",
		Name:         "jcode",
		Dialect:      "toml",
